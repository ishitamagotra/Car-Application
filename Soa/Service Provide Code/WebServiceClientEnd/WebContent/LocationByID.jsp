...
<body background ="E:/wallpapers/truck/truck5.jpg"> <center> <h1 ></h1> 
<h1>Location By ID.... </h1>
<style>
table {
...
<% for(int i=0;i<Array.length;i=i+7){ %>
	<tr>
		...
		<td><% out.println(Array[i+4]); %></td>
		<td><% out.println(Array[i+5]); %></td>
		<td><% out.println(Array[i+6]); %></td>
